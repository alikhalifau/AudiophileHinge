...
const contractABI = require("../artifacts/contracts/Audiophilehinge.sol/Audiophilehinge.json").abi;

program
    .name("audiophilehinge-cli")
    .description("CLI tool for Audiophilehinge smart contract")
    .version("1.0.0");
